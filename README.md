...
Here's an example using the default solution name, if you changed it you would have to adapt it accordingly:
...
### 3. Start the application
 Tthe default API endpoints should be testable from the [Swagger UI](http://localhost:5000/swagger/index.html).
