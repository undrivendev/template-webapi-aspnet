...
using {{cookiecutter.solution_name}}.Application;
...
using {{cookiecutter.solution_name}}.Application.Validation;
...
try
{
    ...
    container.Register<I{{cookiecutter.sample_entity_name}}ReadRepository, {{cookiecutter.sample_entity_name}}ReadRepository>();
    container.Register<I{{cookiecutter.sample_entity_name}}WriteRepository, {{cookiecutter.sample_entity_name}}WriteRepository>();
    container.Register<IUnitOfWorkFactory, UnitOfWorkFactory>();

    // validators
    container.Collection.Register(
        typeof(IValidator<>),
        typeof(Get{{cookiecutter.sample_entity_name}}ByIdQueryValidator).Assembly
    );
    ...
    // mediator handlers
    container.Register(typeof(ICommandHandler<,>), typeof(Create{{cookiecutter.sample_entity_name}}CommandHandler).Assembly);
    container.Register(typeof(IQueryHandler<,>), typeof(Get{{cookiecutter.sample_entity_name}}ByIdQueryHandler).Assembly);
